...
VL_ATTR_COLD void Vdoc5503_harness___024root___eval_initial(Vdoc5503_harness___024root* vlSelf) {
    ...
    vlSelfRef.__Vtrigprevexpr___TOP__reset_n_i__0 = vlSelfRef.reset_n_i;
}
...
VL_ATTR_COLD void Vdoc5503_harness___024root___dump_triggers__act(Vdoc5503_harness___024root* vlSelf) {
    ...
    if ((2ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(negedge reset_n_i)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vdoc5503_harness___024root___dump_triggers__nba(Vdoc5503_harness___024root* vlSelf) {
    ...
    if ((2ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(negedge reset_n_i)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vdoc5503_harness___024root___ctor_var_reset(Vdoc5503_harness___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->doc5503_harness__DOT__freq_low[__Vi0] = VL_RAND_RESET_I(8);
    }
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->doc5503_harness__DOT__freq_high[__Vi0] = VL_RAND_RESET_I(8);
    }
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->doc5503_harness__DOT__volume[__Vi0] = VL_RAND_RESET_I(8);
    }
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->doc5503_harness__DOT__data_sample[__Vi0] = VL_RAND_RESET_I(8);
    }
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->doc5503_harness__DOT__addr_pointer[__Vi0] = VL_RAND_RESET_I(8);
    }
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->doc5503_harness__DOT__control[__Vi0] = VL_RAND_RESET_I(8);
    }
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->doc5503_harness__DOT__resolution_table_size[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->doc5503_harness__DOT__osc_int = VL_RAND_RESET_I(8);
    vlSelf->doc5503_harness__DOT__osc_en = VL_RAND_RESET_I(8);
    vlSelf->doc5503_harness__DOT__unnamedblk1__DOT__i = 0;
    ...
    vlSelf->doc5503_harness__DOT__doc5503_inst__DOT__cycle_max_w = VL_RAND_RESET_I(5);
    ...
    vlSelf->__Vtrigprevexpr___TOP__reset_n_i__0 = VL_RAND_RESET_I(1);
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
