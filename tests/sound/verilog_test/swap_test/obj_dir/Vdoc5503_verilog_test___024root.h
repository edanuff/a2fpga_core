...
class alignas(VL_CACHE_LINE_BYTES) Vdoc5503_verilog_test___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*7:0*/ doc5503_verilog_test__DOT__dut__DOT__osc_halt_r;
    ...
    struct {
        ...
        VlUnpacked<CData/*1:0*/, 8> doc5503_verilog_test__DOT__dut__DOT__osc_mode_o;
        VlUnpacked<CData/*1:0*/, 8> doc5503_verilog_test__DOT__dut__DOT__osc_mode_r;
