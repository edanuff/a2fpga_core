...
feature set that uses SDRAM for Ensoniq audio and a framebuffer that allows
beam-racing game effects to work with the A2N20v2.
...
- A Framebuffer system that allows the system to render more closely to Apple II timing
  so that beam racing effects are preserved in games like Arkanoid and Bugz
