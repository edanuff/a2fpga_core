...
module tb_gs_socket;
    ...
    always @(posedge ph2_bus) begin
        ...
        if (running && be_bus) begin
            ...
            if (!stall_req) begin
                ...
                // repeated cycle (RDY was low): W65C816S 7.6 - no bank byte, the
                // FPI keeps the bank it latched on the previous rise
                bank_l = prev_bank_l;
            end
        end
        ...
        exp_rd_valid = 0;
        if (rw_l) begin
            exp_rd = ({bank_l, addr_l} == 24'h00C030) ? IO_READ[7:0] :
                     ((bank_l[7:1] == 7'b0000000) && (addr_l[15:8] == 8'hC0)) ? 8'h00 :
                     mem[{bank_l, addr_l}];
            exp_rd_valid = 1;
            #(T_ACC);
            if (ph2_bus) begin
    ...
    always @(negedge ph2_bus) begin
        ...
        if (running && be_bus) begin
            if (!rw_l) begin
                ...
                if (!(stall_req)) begin
                    if ({bank_l, addr_l} == 24'h00C036) begin if (!noturbo) slow_mode = ~cpu_val[7]; end
                    else if (!(bank_l[7:1] == 7'b0 && addr_l[15:8] == 8'hC0)) mem[{bank_l, addr_l}] = cpu_val;
                end
            end else begin
    ...
    task automatic load_program();
        // bank 0, ROM at $F000
        mem[24'h00F000] = 8'h78;                                   // SEI
        mem[24'h00F001] = 8'hA9; mem[24'h00F002] = 8'h80;          // LDA #$80
        mem[24'h00F003] = 8'h8D; mem[24'h00F004] = 8'h36; mem[24'h00F005] = 8'hC0; // STA $C036 (fast)
        mem[24'h00F006] = 8'hA9; mem[24'h00F007] = 8'h55;          // LDA #$55
        mem[24'h00F008] = 8'h8D; mem[24'h00F009] = 8'h00; mem[24'h00F00A] = 8'h03; // STA $0300
        mem[24'h00F00B] = 8'hA9; mem[24'h00F00C] = 8'hAA;          // LDA #$AA
        mem[24'h00F00D] = 8'h8D; mem[24'h00F00E] = 8'h01; mem[24'h00F00F] = 8'h03; // STA $0301
        mem[24'h00F010] = 8'hAD; mem[24'h00F011] = 8'h00; mem[24'h00F012] = 8'h03; // LDA $0300
        mem[24'h00F013] = 8'h18;                                   // CLC
        mem[24'h00F014] = 8'h6D; mem[24'h00F015] = 8'h01; mem[24'h00F016] = 8'h03; // ADC $0301
        mem[24'h00F017] = 8'h8D; mem[24'h00F018] = 8'h02; mem[24'h00F019] = 8'h03; // STA $0302
        mem[24'h00F01A] = 8'hEE; mem[24'h00F01B] = 8'h02; mem[24'h00F01C] = 8'h03; // INC $0302
        mem[24'h00F01D] = 8'h20; mem[24'h00F01E] = 8'h40; mem[24'h00F01F] = 8'hF0; // JSR $F040
        mem[24'h00F020] = 8'hA9; mem[24'h00F021] = 8'h01;          // LDA #$01
        mem[24'h00F022] = 8'h8D; mem[24'h00F023] = 8'h03; mem[24'h00F024] = 8'h03; // STA $0303
        mem[24'h00F025] = 8'hAD; mem[24'h00F026] = 8'h30; mem[24'h00F027] = 8'hC0; // LDA $C030
        mem[24'h00F028] = 8'h8F; mem[24'h00F029] = 8'h00; mem[24'h00F02A] = 8'h20; mem[24'h00F02B] = 8'hE1; // STA $E12000
        mem[24'h00F02C] = 8'hAF; mem[24'h00F02D] = 8'h00; mem[24'h00F02E] = 8'h20; mem[24'h00F02F] = 8'hE1; // LDA $E12000
        mem[24'h00F030] = 8'h8D; mem[24'h00F031] = 8'h07; mem[24'h00F032] = 8'h03; // STA $0307
        mem[24'h00F033] = 8'h58;                                   // CLI
        mem[24'h00F034] = 8'h4C; mem[24'h00F035] = 8'h00; mem[24'h00F036] = 8'h04; // JMP $0400 (loop lives in RAM)
        // RAM-resident main loop (RAM accesses are what the FPI refreshes around)
        mem[24'h000400] = 8'hEE; mem[24'h000401] = 8'h06; mem[24'h000402] = 8'h03; // INC $0306
        mem[24'h000403] = 8'hAD; mem[24'h000404] = 8'h00; mem[24'h000405] = 8'h03; // LDA $0300
        mem[24'h000406] = 8'h8D; mem[24'h000407] = 8'h08; mem[24'h000408] = 8'h03; // STA $0308
        mem[24'h000409] = 8'h4C; mem[24'h00040A] = 8'h00; mem[24'h00040B] = 8'h04; // JMP $0400
        mem[24'h00F040] = 8'hA2; mem[24'h00F041] = 8'h42;          // LDX #$42
        mem[24'h00F042] = 8'h8E; mem[24'h00F043] = 8'h04; mem[24'h00F044] = 8'h03; // STX $0304
        mem[24'h00F045] = 8'h60;                                   // RTS
        mem[24'h00F050] = 8'hEE; mem[24'h00F051] = 8'h05; mem[24'h00F052] = 8'h03; // INC $0305
        mem[24'h00F053] = 8'h40;                                   // RTI
        mem[24'h00FFFC] = 8'h00; mem[24'h00FFFD] = 8'hF0;          // RESET vector
        mem[24'h00FFFE] = 8'h50; mem[24'h00FFFF] = 8'hF0;          // IRQ/BRK vector
    endtask
    ...
    initial begin
        ...
        if (refresh_cycles == 0 && !noturbo) err("no refresh cycles occurred");
