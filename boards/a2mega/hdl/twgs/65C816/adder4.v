...
module P65C816_adder4(A, B, CI, S, CO);
   input [3:0]  A;
   input [3:0]  B;
   input        CI;
   output [3:0] S;
   ...
   P65C816_bit_adder b_add0(A[0], B[0], CI, S[0], CO0);

   P65C816_bit_adder b_add1(A[1], B[1], CO0, S[1], CO1);

   P65C816_bit_adder b_add2(A[2], B[2], CO1, S[2], CO2);

   P65C816_bit_adder b_add3(A[3], B[3], CO2, S[3], CO);
