...
wire ahb_clk_o;
wire tl_clkp_i;
wire [47:24] upar_arbiter_wrap_dp_serdes_inst_drp_addr_i;
wire [1:1] upar_arbiter_wrap_dp_serdes_inst_drp_wren_i;
wire [63:32] upar_arbiter_wrap_dp_serdes_inst_drp_wrdata_i;
wire [15:8] upar_arbiter_wrap_dp_serdes_inst_drp_strb_i;
wire [1:1] upar_arbiter_wrap_dp_serdes_inst_drp_rden_i;
wire [7:0] upar_arbiter_wrap_dp_serdes_inst_drp_clk_o;
wire [7:0] upar_arbiter_wrap_dp_serdes_inst_drp_ready_o;
wire [7:0] upar_arbiter_wrap_dp_serdes_inst_drp_rdvld_o;
wire [255:0] upar_arbiter_wrap_dp_serdes_inst_drp_rddata_o;
wire [7:0] upar_arbiter_wrap_dp_serdes_inst_drp_resp_o;
wire gw_vcc;
wire gw_gnd;
...
\~upar_arbiter_wrap.dp_serdes upar_arbiter_wrap_dp_serdes_inst (
    .drp_clk_o({upar_arbiter_wrap_dp_serdes_inst_drp_clk_o[7],upar_arbiter_wrap_dp_serdes_inst_drp_clk_o[6],upar_arbiter_wrap_dp_serdes_inst_drp_clk_o[5],upar_arbiter_wrap_dp_serdes_inst_drp_clk_o[4],upar_arbiter_wrap_dp_serdes_inst_drp_clk_o[3],upar_arbiter_wrap_dp_serdes_inst_drp_clk_o[2],upar_arbiter_wrap_dp_serdes_inst_drp_clk_o[1],upar_arbiter_wrap_dp_serdes_inst_drp_clk_o[0]}),
    .drp_ready_o({upar_arbiter_wrap_dp_serdes_inst_drp_ready_o[7],upar_arbiter_wrap_dp_serdes_inst_drp_ready_o[6],upar_arbiter_wrap_dp_serdes_inst_drp_ready_o[5],upar_arbiter_wrap_dp_serdes_inst_drp_ready_o[4],upar_arbiter_wrap_dp_serdes_inst_drp_ready_o[3],upar_arbiter_wrap_dp_serdes_inst_drp_ready_o[2],upar_arbiter_wrap_dp_serdes_inst_drp_ready_o[1],upar_arbiter_wrap_dp_serdes_inst_drp_ready_o[0]}),
    .drp_rdvld_o({upar_arbiter_wrap_dp_serdes_inst_drp_rdvld_o[7],upar_arbiter_wrap_dp_serdes_inst_drp_rdvld_o[6],upar_arbiter_wrap_dp_serdes_inst_drp_rdvld_o[5],upar_arbiter_wrap_dp_serdes_inst_drp_rdvld_o[4],upar_arbiter_wrap_dp_serdes_inst_drp_rdvld_o[3],upar_arbiter_wrap_dp_serdes_inst_drp_rdvld_o[2],upar_arbiter_wrap_dp_serdes_inst_drp_rdvld_o[1],upar_arbiter_wrap_dp_serdes_inst_drp_rdvld_o[0]}),
    .drp_rddata_o({upar_arbiter_wrap_dp_serdes_inst_drp_rddata_o[255:224],upar_arbiter_wrap_dp_serdes_inst_drp_rddata_o[223:192],upar_arbiter_wrap_dp_serdes_inst_drp_rddata_o[191:160],upar_arbiter_wrap_dp_serdes_inst_drp_rddata_o[159:128],upar_arbiter_wrap_dp_serdes_inst_drp_rddata_o[127:96],upar_arbiter_wrap_dp_serdes_inst_drp_rddata_o[95:64],upar_arbiter_wrap_dp_serdes_inst_drp_rddata_o[63:32],upar_arbiter_wrap_dp_serdes_inst_drp_rddata_o[31:0]}),
    .drp_resp_o({upar_arbiter_wrap_dp_serdes_inst_drp_resp_o[7],upar_arbiter_wrap_dp_serdes_inst_drp_resp_o[6],upar_arbiter_wrap_dp_serdes_inst_drp_resp_o[5],upar_arbiter_wrap_dp_serdes_inst_drp_resp_o[4],upar_arbiter_wrap_dp_serdes_inst_drp_resp_o[3],upar_arbiter_wrap_dp_serdes_inst_drp_resp_o[2],upar_arbiter_wrap_dp_serdes_inst_drp_resp_o[1],upar_arbiter_wrap_dp_serdes_inst_drp_resp_o[0]}),
    .upar_rst_o(upar_rst),
    ...
    .drp_addr_i({gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,upar_arbiter_wrap_dp_serdes_inst_drp_addr_i[47:24],gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd}),
    .drp_wren_i({gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,upar_arbiter_wrap_dp_serdes_inst_drp_wren_i[1],gw_gnd}),
    .drp_wrdata_i({gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,upar_arbiter_wrap_dp_serdes_inst_drp_wrdata_i[63:32],gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd}),
    .drp_strb_i({gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,upar_arbiter_wrap_dp_serdes_inst_drp_strb_i[15:8],gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd}),
    .drp_rden_i({gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,gw_gnd,upar_arbiter_wrap_dp_serdes_inst_drp_rden_i[1],gw_gnd}),
...
dp_phy dp_phy_inst (
    ...
    .drp_addr_o(upar_arbiter_wrap_dp_serdes_inst_drp_addr_i[47:24]),
    .drp_wren_o(upar_arbiter_wrap_dp_serdes_inst_drp_wren_i[1]),
    ...
    .drp_clk_i(upar_arbiter_wrap_dp_serdes_inst_drp_clk_o[1]),
    .drp_ready_i(upar_arbiter_wrap_dp_serdes_inst_drp_ready_o[1]),
    .drp_rdvld_i(upar_arbiter_wrap_dp_serdes_inst_drp_rdvld_o[1]),
    .drp_rddata_i(upar_arbiter_wrap_dp_serdes_inst_drp_rddata_o[63:32]),
    .drp_resp_i(upar_arbiter_wrap_dp_serdes_inst_drp_resp_o[1]),
