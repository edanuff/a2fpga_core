...
module dp_serdes (edp_phy_ln2_cpll_ok_o, edp_phy_ln2_pma_rx_lock_o, edp_phy_ln2_align_link_o, edp_phy_ln2_k_lock_o, edp_phy_ln2_pcs_rx_clk_o, edp_phy_ln2_rxfifo_aempty_o, edp_phy_ln2_pcs_tx_clk_o, edp_phy_ln2_txfifo_afull_o, edp_phy_ln2_rxdata_o, edp_phy_ln2_rxk_o, edp_phy_ln3_cpll_ok_o, edp_phy_ln3_pma_rx_lock_o, edp_phy_ln3_align_link_o, edp_phy_ln3_k_lock_o, edp_phy_ln3_pcs_rx_clk_o, edp_phy_ln3_rxfifo_aempty_o, edp_phy_ln3_pcs_tx_clk_o, edp_phy_ln3_txfifo_afull_o, edp_phy_ln3_rxdata_o, edp_phy_ln3_rxk_o, edp_phy_qpll0_ok_o, edp_phy_qpll1_ok_o, edp_phy_ln2_rxfifo_rdusewd_o, edp_phy_ln2_rxfifo_empty_o, edp_phy_ln2_txfifo_wrusewd_o, edp_phy_ln2_txfifo_full_o, edp_phy_ln3_rxfifo_rdusewd_o, edp_phy_ln3_rxfifo_empty_o, edp_phy_ln3_txfifo_wrusewd_o, edp_phy_ln3_txfifo_full_o, edp_phy_drp_clk_o, edp_phy_drp_ready_o, edp_phy_drp_rdvld_o, edp_phy_drp_rddata_o, edp_phy_drp_resp_o, por_n_i, edp_phy_ln2_fabric_rstn_i, edp_phy_ln2_rx_rst_i, edp_phy_ln2_fabric_rx_clk_i, edp_phy_ln2_rxfifo_rden_i, edp_phy_ln2_tx_rst_i, edp_phy_ln2_fabric_tx_clk_i, edp_phy_ln2_tx_vld_i, edp_phy_ln2_txdata_i, edp_phy_ln2_txk_i, edp_phy_ln3_fabric_rstn_i, edp_phy_ln3_rx_rst_i, edp_phy_ln3_fabric_rx_clk_i, edp_phy_ln3_rxfifo_rden_i, edp_phy_ln3_tx_rst_i, edp_phy_ln3_fabric_tx_clk_i, edp_phy_ln3_tx_vld_i, edp_phy_ln3_txdata_i, edp_phy_ln3_txk_i, edp_phy_ln2_chbond_start_i, edp_phy_ln3_chbond_start_i, edp_phy_drp_addr_i, edp_phy_drp_wren_i, edp_phy_drp_wrdata_i, edp_phy_drp_strb_i, edp_phy_drp_rden_i);

output edp_phy_ln2_cpll_ok_o;
output edp_phy_ln2_pma_rx_lock_o;
output edp_phy_ln2_align_link_o;
output edp_phy_ln2_k_lock_o;
output edp_phy_ln2_pcs_rx_clk_o;
output edp_phy_ln2_rxfifo_aempty_o;
output edp_phy_ln2_pcs_tx_clk_o;
output edp_phy_ln2_txfifo_afull_o;
output [31:0] edp_phy_ln2_rxdata_o;
output [3:0] edp_phy_ln2_rxk_o;
output edp_phy_ln3_cpll_ok_o;
output edp_phy_ln3_pma_rx_lock_o;
output edp_phy_ln3_align_link_o;
output edp_phy_ln3_k_lock_o;
output edp_phy_ln3_pcs_rx_clk_o;
output edp_phy_ln3_rxfifo_aempty_o;
output edp_phy_ln3_pcs_tx_clk_o;
output edp_phy_ln3_txfifo_afull_o;
output [31:0] edp_phy_ln3_rxdata_o;
output [3:0] edp_phy_ln3_rxk_o;
output edp_phy_qpll0_ok_o;
output edp_phy_qpll1_ok_o;
output [4:0] edp_phy_ln2_rxfifo_rdusewd_o;
output edp_phy_ln2_rxfifo_empty_o;
output [4:0] edp_phy_ln2_txfifo_wrusewd_o;
output edp_phy_ln2_txfifo_full_o;
output [4:0] edp_phy_ln3_rxfifo_rdusewd_o;
output edp_phy_ln3_rxfifo_empty_o;
output [4:0] edp_phy_ln3_txfifo_wrusewd_o;
output edp_phy_ln3_txfifo_full_o;
...
input por_n_i;
input edp_phy_ln2_fabric_rstn_i;
input edp_phy_ln2_rx_rst_i;
input edp_phy_ln2_fabric_rx_clk_i;
input edp_phy_ln2_rxfifo_rden_i;
input edp_phy_ln2_tx_rst_i;
input edp_phy_ln2_fabric_tx_clk_i;
input edp_phy_ln2_tx_vld_i;
input [31:0] edp_phy_ln2_txdata_i;
input [3:0] edp_phy_ln2_txk_i;
input edp_phy_ln3_fabric_rstn_i;
input edp_phy_ln3_rx_rst_i;
input edp_phy_ln3_fabric_rx_clk_i;
input edp_phy_ln3_rxfifo_rden_i;
input edp_phy_ln3_tx_rst_i;
input edp_phy_ln3_fabric_tx_clk_i;
input edp_phy_ln3_tx_vld_i;
input [31:0] edp_phy_ln3_txdata_i;
input [3:0] edp_phy_ln3_txk_i;
input edp_phy_ln2_chbond_start_i;
input edp_phy_ln3_chbond_start_i;
...
edp_phy edp_phy_inst (
    .serdes_ln2_fabric_rstn_o(q0_fabric_ln2_rstn_i),
    .serdes_ln2_rx_rst_o(q0_lane2_pcs_rx_rst),
    .serdes_ln2_fabric_rx_clk_o(q0_lane2_fabric_rx_clk),
    .serdes_ln2_rxfifo_rden_o(q0_lane2_rx_if_fifo_rden),
    .serdes_ln2_tx_rst_o(q0_lane2_pcs_tx_rst),
    .serdes_ln2_fabric_tx_clk_o(q0_lane2_fabric_tx_clk),
    .serdes_ln2_txdata_o(q0_fabric_ln2_txdata_i[79:0]),
    .serdes_ln2_tx_vld_o(q0_fabric_ln2_tx_vld_in),
    .ln2_cpll_ok_o(edp_phy_ln2_cpll_ok_o),
    .ln2_pma_rx_lock_o(edp_phy_ln2_pma_rx_lock_o),
    .ln2_align_link_o(edp_phy_ln2_align_link_o),
    .ln2_k_lock_o(edp_phy_ln2_k_lock_o),
    .ln2_pcs_rx_clk_o(edp_phy_ln2_pcs_rx_clk_o),
    .ln2_rxfifo_aempty_o(edp_phy_ln2_rxfifo_aempty_o),
    .ln2_pcs_tx_clk_o(edp_phy_ln2_pcs_tx_clk_o),
    .ln2_txfifo_afull_o(edp_phy_ln2_txfifo_afull_o),
    .ln2_rxdata_o(edp_phy_ln2_rxdata_o[31:0]),
    .ln2_rxk_o(edp_phy_ln2_rxk_o[3:0]),
    .serdes_ln3_fabric_rstn_o(q0_fabric_ln3_rstn_i),
    .serdes_ln3_rx_rst_o(q0_lane3_pcs_rx_rst),
    .serdes_ln3_fabric_rx_clk_o(q0_lane3_fabric_rx_clk),
    .serdes_ln3_rxfifo_rden_o(q0_lane3_rx_if_fifo_rden),
    .serdes_ln3_tx_rst_o(q0_lane3_pcs_tx_rst),
    .serdes_ln3_fabric_tx_clk_o(q0_lane3_fabric_tx_clk),
    .serdes_ln3_txdata_o(q0_fabric_ln3_txdata_i[79:0]),
    .serdes_ln3_tx_vld_o(q0_fabric_ln3_tx_vld_in),
    .ln3_cpll_ok_o(edp_phy_ln3_cpll_ok_o),
    .ln3_pma_rx_lock_o(edp_phy_ln3_pma_rx_lock_o),
    .ln3_align_link_o(edp_phy_ln3_align_link_o),
    .ln3_k_lock_o(edp_phy_ln3_k_lock_o),
    .ln3_pcs_rx_clk_o(edp_phy_ln3_pcs_rx_clk_o),
    .ln3_rxfifo_aempty_o(edp_phy_ln3_rxfifo_aempty_o),
    .ln3_pcs_tx_clk_o(edp_phy_ln3_pcs_tx_clk_o),
    .ln3_txfifo_afull_o(edp_phy_ln3_txfifo_afull_o),
    .ln3_rxdata_o(edp_phy_ln3_rxdata_o[31:0]),
    .ln3_rxk_o(edp_phy_ln3_rxk_o[3:0]),
    .qpll0_ok_o(edp_phy_qpll0_ok_o),
    .qpll1_ok_o(edp_phy_qpll1_ok_o),
    .serdes_ln2_chbond_start_o(q0_lane2_chbond_start),
    .serdes_ln3_chbond_start_o(q0_lane3_chbond_start),
    .ln2_rxfifo_rdusewd_o(edp_phy_ln2_rxfifo_rdusewd_o[4:0]),
    .ln2_rxfifo_empty_o(edp_phy_ln2_rxfifo_empty_o),
    .ln2_txfifo_wrusewd_o(edp_phy_ln2_txfifo_wrusewd_o[4:0]),
    .ln2_txfifo_full_o(edp_phy_ln2_txfifo_full_o),
    .ln3_rxfifo_rdusewd_o(edp_phy_ln3_rxfifo_rdusewd_o[4:0]),
    .ln3_rxfifo_empty_o(edp_phy_ln3_rxfifo_empty_o),
    .ln3_txfifo_wrusewd_o(edp_phy_ln3_txfifo_wrusewd_o[4:0]),
    .ln3_txfifo_full_o(edp_phy_ln3_txfifo_full_o),
    ...
    .serdes_ln2_cpll_ok_i(q0_fabric_lane2_cmu_ok_o),
    .serdes_ln2_pma_rx_lock_i(q0_fabric_ln2_pma_rx_lock_o),
    .serdes_ln2_align_link_i(q0_lane2_align_link),
    .serdes_ln2_k_lock_i(q0_lane2_k_lock),
    .serdes_ln2_pcs_rx_clk_i(q0_lane2_pcs_rx_o_fabric_clk),
    .serdes_ln2_rxdata_i(q0_fabric_ln2_rxdata_o[87:0]),
    .serdes_ln2_rxfifo_aempty_i(q0_lane2_rx_if_fifo_aempty),
    .serdes_ln2_pcs_tx_clk_i(q0_lane2_pcs_tx_o_fabric_clk),
    .serdes_ln2_txfifo_afull_i(q0_lane2_tx_if_fifo_afull),
    .ln2_fabric_rstn_i(edp_phy_ln2_fabric_rstn_i),
    .ln2_rx_rst_i(edp_phy_ln2_rx_rst_i),
    .ln2_fabric_rx_clk_i(edp_phy_ln2_fabric_rx_clk_i),
    .ln2_rxfifo_rden_i(edp_phy_ln2_rxfifo_rden_i),
    .ln2_tx_rst_i(edp_phy_ln2_tx_rst_i),
    .ln2_fabric_tx_clk_i(edp_phy_ln2_fabric_tx_clk_i),
    .ln2_tx_vld_i(edp_phy_ln2_tx_vld_i),
    .ln2_txdata_i(edp_phy_ln2_txdata_i[31:0]),
    .ln2_txk_i(edp_phy_ln2_txk_i[3:0]),
    .serdes_ln3_cpll_ok_i(q0_fabric_lane3_cmu_ok_o),
    .serdes_ln3_pma_rx_lock_i(q0_fabric_ln3_pma_rx_lock_o),
    .serdes_ln3_align_link_i(q0_lane3_align_link),
    .serdes_ln3_k_lock_i(q0_lane3_k_lock),
    .serdes_ln3_pcs_rx_clk_i(q0_lane3_pcs_rx_o_fabric_clk),
    .serdes_ln3_rxdata_i(q0_fabric_ln3_rxdata_o[87:0]),
    .serdes_ln3_rxfifo_aempty_i(q0_lane3_rx_if_fifo_aempty),
    .serdes_ln3_pcs_tx_clk_i(q0_lane3_pcs_tx_o_fabric_clk),
    .serdes_ln3_txfifo_afull_i(q0_lane3_tx_if_fifo_afull),
    .ln3_fabric_rstn_i(edp_phy_ln3_fabric_rstn_i),
    .ln3_rx_rst_i(edp_phy_ln3_rx_rst_i),
    .ln3_fabric_rx_clk_i(edp_phy_ln3_fabric_rx_clk_i),
    .ln3_rxfifo_rden_i(edp_phy_ln3_rxfifo_rden_i),
    .ln3_tx_rst_i(edp_phy_ln3_tx_rst_i),
    .ln3_fabric_tx_clk_i(edp_phy_ln3_fabric_tx_clk_i),
    .ln3_tx_vld_i(edp_phy_ln3_tx_vld_i),
    .ln3_txdata_i(edp_phy_ln3_txdata_i[31:0]),
    .ln3_txk_i(edp_phy_ln3_txk_i[3:0]),
    .serdes_qpll0_ok_i(q0_fabric_cmu_ok_o),
    .serdes_qpll1_ok_i(q0_fabric_cmu1_ok_o),
    .serdes_ln2_rxfifo_rdusewd_i(q0_lane2_rx_if_fifo_rdusewd[4:0]),
    .serdes_ln2_rxfifo_empty_i(q0_lane2_rx_if_fifo_empty),
    .serdes_ln2_txfifo_wrusewd_i(q0_lane2_tx_if_fifo_wrusewd[4:0]),
    .serdes_ln2_txfifo_full_i(q0_lane2_tx_if_fifo_full),
    .serdes_ln3_rxfifo_rdusewd_i(q0_lane3_rx_if_fifo_rdusewd[4:0]),
    .serdes_ln3_rxfifo_empty_i(q0_lane3_rx_if_fifo_empty),
    .serdes_ln3_txfifo_wrusewd_i(q0_lane3_tx_if_fifo_wrusewd[4:0]),
    .serdes_ln3_txfifo_full_i(q0_lane3_tx_if_fifo_full),
    .ln2_chbond_start_i(edp_phy_ln2_chbond_start_i),
    .ln3_chbond_start_i(edp_phy_ln3_chbond_start_i),
