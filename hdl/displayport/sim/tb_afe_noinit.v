...
module tb_afe_noinit;
    ...
    initial begin
        ...
        if (byte_o[7:0] !== 8'h06) begin errors = errors + 1; $display("FAIL: declared byte %02x (want 0x06)", byte_o[7:0]); end
        ...
        if (wr_cnt != 8 || wr_data[0] !== {16'd0, 4'd9, 12'd0} || byte_o[7:0] !== 8'h01) begin
            errors = errors + 1; $display("FAIL: VS1 apply: writes %0d data0 %08x byte %02x", wr_cnt, wr_data[0], byte_o[7:0]); end
        ...
        if (wr_cnt != 16 || wr_data[8] !== {16'd0, 4'd13, 12'd0} || byte_o[7:0] !== 8'h06) begin
            errors = errors + 1; $display("FAIL: back-to-INIT: writes %0d data8 %08x byte %02x", wr_cnt, wr_data[8], byte_o[7:0]); end
